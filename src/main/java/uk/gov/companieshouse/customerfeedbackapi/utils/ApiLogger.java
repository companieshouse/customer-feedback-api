...
import uk.gov.companieshouse.customerfeedbackapi.CustomerFeedbackApiApplication;
...
public class ApiLogger {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(CustomerFeedbackApiApplication.CFAPI_APP_NAMESPACE);
  ...
  public static void errorContext(
